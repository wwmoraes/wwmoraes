...
- [artur-graniszewski/DLSS-Enabler](https://github.com/artur-graniszewski/DLSS-Enabler) - Simulate DLSS Upscaler and DLSS-G Frame Generation features on any DirectX 12 compatible GPU in any DirectX 12 game that supports DLSS2 and DLSS3 natively. (4 days ago)
- [noperator/yknotify](https://github.com/noperator/yknotify) - Notify when YubiKey needs touch on macOS (4 days ago)
...
- [woodruffw/zizmor](https://github.com/woodruffw/zizmor) - Static analysis for GitHub Actions (6 days ago)
...
- [grafana/beyla](https://github.com/grafana/beyla) - eBPF-based autoinstrumentation of web applications and network metrics (1 week ago)
