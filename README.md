...
- [microsoft/terraform-provider-azuredevops](https://github.com/microsoft/terraform-provider-azuredevops) ([v0.7.0](https://github.com/microsoft/terraform-provider-azuredevops/releases/tag/v0.7.0), 4 days ago) - Terraform Azure DevOps provider
...
- [r3labs/diff](https://github.com/r3labs/diff) - A library for diffing golang structures (3 days ago)
