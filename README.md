...
- [wwmoraes/fish-pre-commit-completions](https://github.com/wwmoraes/fish-pre-commit-completions) - pre-commit completions for Fish shell (6 days ago)
...
- [openbao/openbao](https://github.com/openbao/openbao) -  (3 days ago)
